...
// This class holds all arrays of Strings to be called.

public class phrases {
    public String[] angryQuotesBefore18 = {           ///Loading angry quotes for persons under 18 into an array
            "Don't get mad, smile and creep them out instead",
            "Your too amazing to let someone upset you",
    };
    public String [] sadQuotesBefore18 = {          ///Loading sad quotes for persons under 18 into an array
            "being sad is a waste of time",
            "its ok to feel sad, the sky cries too, just remember that the sun comes out at some point",
            "Someone loves you honey",

    };
    public   String [] happyQuotesBefore18 = {         ///Loading happy quotes for persons under 18 into an array
            "Our phones fall we panic our friends fall we laugh :D ",
            "All my life i thought air was free until i bought a bag of chips"
    };

    public  String[] angryQuotesAfter18 = {          ///Loading angry quotes for persons 18 and over into an array
            ...
            "If you want to kill someone just do it in your mind, you can express your full creativity there and there are no rules"
    };

    public String [] sadQuotesAfter18 = {       ///Loading sad quotes for persons 18 and over into an array
            "Whenever your feeling sad just remember there is an idiot pulling a door that says 'push'",
    ...
    public   String [] happyQuotesAfter18 = {          ///Loading happy quotes for persons 18 and over into an array
